 ...
 <html>  
      ...
      <body>  
           <br />  
           <div class="container" style="min-width:150px; max-width:800px;">  
                <?php  
                ...
                {  
					 ...
					 $query1 = 'SELECT Emri FROM produktet';
                     ...
                     {  
						 ...
						 {
							if($row3["Emri"] == $row["product_name"]){
								$query2 = 'UPDATE produktet SET Porositur = Porositur + 1 WHERE Emri = $row["product_name"]';
