                ...
                <div class="tab-content">  
                     <div id="products" class="tab-pane fade in active">  
							<div class="box">
								<div class="row">
									 <?php  
									 $query = "SELECT * FROM produktet WHERE Lloji = 'Buke'";  
                          ...
                          <div class="table-responsive" id="order_table">  
                               <table class="table table-bordered">  
                                    ...
                                    <tr>  
                                         ...
                                         <td><input type="text" name="quantity[]" id="quantity<?php echo $values["product_id"]; ?>" value="<?php echo $values["product_quantity"]; ?>" data-product_id="<?php echo $values["product_id"]; ?>" class="form-control" /></td>  
